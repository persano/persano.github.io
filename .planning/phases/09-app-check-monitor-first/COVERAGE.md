# API Coverage — Firebase App Check (reCAPTCHA v3) + reCAPTCHA v3 attestation

> Full coverage by default. Opt-outs are explicit, reasoned decisions.
> Phase 9 integrates the Firebase App Check web SDK (`firebase-app-check.js`, gstatic 12.18.0 exact-pinned)
> on the `contact.js` submit path, plus the reCAPTCHA v3 attestation provider (D-01).
...
| ReCaptchaEnterpriseProvider | OPT-OUT | D-01 locked reCAPTCHA v3 — Enterprise rejected (Cloud Billing + console complexity unjustified) |
