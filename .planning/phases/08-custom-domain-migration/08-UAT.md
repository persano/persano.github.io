...
number: 1
name: Live contact-form test at the new domain
expected: |
  Submitting a real test message at https://geohisttrivia.com/geohist/contact.html shows the
  success state; the message lands in the Firestore `messages` collection (Firebase console).
