...
- [ ] 10-01-PLAN.md — Facts strip (4 pills, 5 keys × 19 dicts) + Tier-1 hidden proof row (2 keys × 19 dicts) + [hidden] insurance CSS, two atomic commits (SEO-05, SEO-06)
...
| 10. Gated Social Proof | v2.0 | 0/2 | Not started | - |
