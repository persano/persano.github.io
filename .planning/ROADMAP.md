...
- [x] 11-01-PLAN.md — F-1 AGENTS.md rewrite + PROJECT.md line-5 URL fix + old-domain-gate allowlist drop (D-01..D-04)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 11-02-PLAN.md — F-2/F-3/F-4 hygiene batch + HV-06/HV-09a/HV-09b owner UAT records + F-5 header flip (D-05..D-09)
